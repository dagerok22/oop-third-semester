...
namespace WindowsFormsApplication3
{
    public partial class Form1 : Form
    {
        ...
        private void create_Ellipse(MouseEventArgs e)
        {
            ...
            else
            {
                ...
                int rx = (temp_points[1].X - temp_points[0].X);
                int ry = (temp_points[2].Y - temp_points[0].Y);
                
                
                try
                {
                    figures.Add(new Ellipse(temp_points[0], new Point(rx, ry)));
                ...
                if (count_click > 1)
                    switch (cboxSelectedType.Text.Length)
                    {
                        ...
                        case PENTAGON:
                            ...
                            break;
                         case ELLIPSE:
                                temp_points[2] = new Point(0, field.Height - e.Y);
                            break;
                            default:
                            break;
                    }
        ...
        private void btn_Delete_Sel_Shape(object sender, EventArgs e)
        {
            if (count_figures > 0)
            {
                ...
                cboxCountFigures.SelectedItem = 0;
            }
            field.Focus();
        }
    ...
    public class Ellipse : Shape
    {
        ...
        public Ellipse()
        {
            static_points = new Point[1];
            radius = new Point(150, 50);
        ...
        public Ellipse(Point cntr, Point radius)
        {
            static_points = new Point[1];
            static_points[0] = cntr;
            this.radius = radius;
